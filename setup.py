...
setup(
    name="azul-plugin-truncated",
    description="Partially hash files to find untruncated versions.",
    author="Azul",
    author_email="azul@asd.gov.au",
    url="https://www.asd.gov.au/",
    packages=["azul_plugin_truncated"],
    include_package_data=True,
    python_requires=">=3.12",
    classifiers=[],
    entry_points={
        "console_scripts": [
            "azul-plugin-truncated = azul_plugin_truncated.main:main",
        ]
    },
